/***********************************************************************
  ...
  Now throws an exception if an object has multiple key/value pairs with
  the same key.  Useful for SCXIB to avoid copy and paste errors within
  Interface Builder
                ...
                "object": function(props) {
                        ...
                        return "{" + newline + with_indent(function(){
                                ...
                                return props.map(function(p){
                                        ...
                                        {
                                            // Sproutcore will drop a child view if the name of the variable is defined more than once
                                            // in the view definition
                                            throw "Key " + key + " defined multiple times in parent object! Aborting...";
                                        }
                                        else
                                        {
                                            keyMap[key] = val;
